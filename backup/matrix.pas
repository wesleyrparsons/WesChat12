...
// cublas functions.
function cublasCreate_v2(out handle: TcublasHandle): Integer; cdecl; external cudartDLL;
function cublasDestroy_v2(handle: TcublasHandle): Integer; cdecl; external cudartDLL;
