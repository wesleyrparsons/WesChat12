...
begin
  with WModelParams.ParamBlock[Blk] do with WModelState.StateBlock[Blk] do begin
    ...
    Writeln('' : Blk * 2 + 2, '1A. Transform Forward, Layer Norm X');
    ...
    Writeln('' : Blk * 2 + 2, '1B-C. Transform Forward 1B, implicit split X1 into X1 and accumulate into X4, and Obtain Q, K, V from X1');
    ...
    Writeln('' : Blk * 2 + 2, '1E-G. Transform Forward, Obtain Scores1, Autoregressive mask, obtain Scores2, Softmax, ADropout');
    ...
    Writeln('' : Blk * 2 + 2, '1H. Transform Forward, Obtain X3 by weighting X2 by W0');
    ...
    Writeln('          Transform Forward 1I, Obtain X4 from X1 and X3');
    ...
    Writeln('          Transform Forward 1J, Obtain X5 from Layer Norm Forward X4');
    ...
    if VeryVerboseTransform then begin
      ...
      Writeln('            Transform Forward 2A, Obtain Hidden1 from X5 and W1');
      ...
      Writeln('            Transform Forward 2B, Obtain Hidden1 from Hidden1 and b1');
      ...
      Writeln('            Transform Forward 2C, Obtain Hidden2 by ReLU Forward from Hidden1');
      ...
      Writeln('            Transform Forward 2D, Obtain X6 from Hidden2');
      ...
      Writeln('            Transform Forward 2E, Obtain X6 from X6 and b2');
      ...
      Writeln('            Transform Forward 2F, Obtain X7 from X5 and X6, and RDropout');
