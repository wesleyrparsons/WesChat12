 ...
 */
cublasStatus_t CUBLASWINAPI cublasLtGroupedMatrixLayoutInit_internal(  //
    cublasLtMatrixLayout_t matLayout,
    size_t size,
    cudaDataType type,
    int groupCount,
 ...
 * \retval     CUBLAS_STATUS_SUCCESS       if desciptor was created successfully
 */
static inline cublasStatus_t cublasLtGroupedMatrixLayoutInit(cublasLtMatrixLayout_t matLayout,
                                                             cudaDataType type,
                                                             int groupCount,
                                                             const void* rows_array,
                                                             const void* cols_array,
                                                             const void* ld_array) {
  return cublasLtGroupedMatrixLayoutInit_internal(
      matLayout, sizeof(*matLayout), type, groupCount, rows_array, cols_array, ld_array);
}
 ...
 * \retval     CUBLAS_STATUS_SUCCESS       if desciptor was created successfully
 */
cublasStatus_t CUBLASWINAPI cublasLtGroupedMatrixLayoutCreate(cublasLtMatrixLayout_t* matLayout,
                                                              cudaDataType type,
                                                              int groupCount,
                                                              const void* rows_array,
                                                              const void* cols_array,
