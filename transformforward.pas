...
begin
  with WModelParams.ParamBlock[Blk] do with WModelState.StateBlock[Blk] do begin
    ...
    for h := 0 to nHead - 1 do begin
      ...
      LaunchSoftmaxForward(ScoresHead1[h].dValue, ScoresHead2[h].dValue, SeqLen, SeqLen, Temperature);
    ...
    // MatAdd(X.Value, X3.Value, X4.Value, SeqLen, ModelDim);
    ...
    if VerboseTransform then begin
      ...
      // MatAdd(X4.Value, X6.Value, X7.Value, SeqLen, ModelDim);
